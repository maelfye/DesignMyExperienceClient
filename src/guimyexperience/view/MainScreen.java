...
public class MainScreen extends javax.swing.JFrame {
    ...
    public MainScreen(User user) {
      ...
      public MainScreen() {
        this.loggedInUser = null; // No user is logged in yet
        initComponents();
  ...
  if (loggedInUser instanceof Client) {
        ...
        } else if (loggedInUser instanceof BusinessOwner) {
            BusinessOwnerInterface businessOwnerInterface = new BusinessOwnerInterface();
            businessOwnerInterface.setVisible(true);
        }
